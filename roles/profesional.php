...
include_once "../controlador/reg_profesional.php";
...
<body>
    ...
    <h1 class="text-center p-3">Profesional</h1>

    <div class="container-fluid row">

        <form class="col-4 p3" method="POST">

            <h3 class="text-center text-secondary">Registro de profesional</h3>
            ...
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Especializacion</label>
